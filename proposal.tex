...
We propose to target VIPERS/VVDS with VISTA, increasing the existing overlap area between deep spectroscopy and VISTA photometry by a factor of ten, in order to remove this bottleneck. 
