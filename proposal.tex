...
improve the overall quality of the photometric redshift estimates (used to define the tomographic bins) by including VIKING data, which will enable us to define a fifth tomographic bin beyond redshift 0.9. Adding this fifth high-$z$ bin will increase the volume and hence the statistical power of KiDS by an estimated 20\%.
