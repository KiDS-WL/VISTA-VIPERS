...
Our immediate goal is to increase the area of sky that can be used for CC redshift calibration by a factor of ten (i.e., to 15 square degrees) and hence make it a viable way to calibrate the photometric redshifts of KiDS and similar-depth surveys. KiDS +VIKING provide 9-band $ugriZYJHK$ fluxes for galaxies with a median redshifts of 0.7, and their depth is well-matched to the $i=22.5$ magnitude limit of VIPERS (sparse, but wide area) and VVDS (complete, narrow area). In addition to a contiguous VIPERS area we also include two isolated deep fields, VVDS F02 and ??, to beat down cosmic variance for the DIR calibration scheme which is currently tied to just three deep fields (COSMOS and CDFS, and one of the DEEP2 fields).
...
\MakeCaption{Fig.1: Numbers of spectroscopic redshifts available in GAMA, VIPERS and SDSS, vs. the number that could be used in the KiDS-450 CC calibration of Hildebrandt et al. (2017). GAMA overlaps with KiDS ans will be used at $z<0.5$; with the proposed KiDS/VIKING-like imaging of the VIPERS area we will be able to do the same at higher redshift. }

\MakePicture{banana_DIR_vs_CC_vs_Planck.pdf}{height=8cm}
\MakeCaption{Fig. 2: Cosmology constraints from KiDS-450 using the different photometric redshift calibration strategies. The aim of this proposal is to reduce the CC errors by a factor of $\sqrt{10}$ to bring them in line with the DIR calibration accuracy.}
...
\Target{A}{VIPERS-W1}{00 00 00}{00 00 00}{2.5h}{}{1.5d}{Pointing 1}{}
\Target{A}{VIPERS-W1}{00 00 00}{00 00 00}{2.5}{}{1.5d}{Pointing 1}{}
\Target{A}{VIPERS-W1}{00 00 00}{00 00 00}{2.5}{}{1.5d}{Pointing 1}{}
\Target{A}{VIPERS-W1}{00 00 00}{00 00 00}{2.5}{}{1.5d}{Pointing 1}{}
\Target{A}{VIPERS-W1}{00 00 00}{00 00 00}{2.5}{}{1.5d}{Pointing 1}{}
\Target{A}{VIPERS-W1}{00 00 00}{00 00 00}{2.5}{}{1.5d}{Pointing 1}{}
...
\TargetNotes{These observations do not cover the entire VIPERS area, but target a stripe which contains ten times as many galaxies with spectroscopic redshifts down to $i=22.5$ than are available in VISTA pointings thus far.}
