...
\TargetNotes{These observations do not cover the entire VIPERS area, but target two stripes which contain ten times as many galaxies with spectroscopic redshifts down to $i=22.5$ as are available in VISTA fields thus far.\\
