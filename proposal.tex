...
\MakeCaption{Fig.~3: Photometric vs. spectroscopic redshifts using four optical KiDS bands as it was done in H17 (\emph{left}) and using optical and near-infrared data from KiDS and VIKING (\emph{right}).}
