...
By targeting VIPERS and VVDS with VISTA we will increase the existing overlap area between deep spectroscopy and near-IR photometry by a factor of ten, and remove this bottleneck for cosmic shear surveys.
...
\ObservingRun{B}{102}{VIRCAM}{5.0h}{oct}{n}{1.2}{THN}{s}{}
...
\AwardedNights{VISTA}{30h awarded in P100; 12.5h were executed.}
...
\SpecialRemarks{Associated observations of the same fields with VST have mostly already been obtained; the remainder are in the KiDS public survey queue.}
...
A DDT proposal, similar to this one but observing only two tiles (overlapping with the DEEP2 redshift survey), was submitted in November 2016. The data have been analysed and included in the KiDS+VIKING photo-z calibration. The results in the right-hand panel of Fig.~2 are directly based on these data.

This proposal was accepted for P100 but only 40\% executed. Unfortunately the data resulted in only one further pointing with complete ZYJHKs coverage. This proposal will increase that number to 12.
