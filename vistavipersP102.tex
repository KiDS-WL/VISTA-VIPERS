...
\RequestedDataRemark{
We have taken account of the existing VIDEO data that covers part of W1 and avoid overlap.
...
\medskip
We only request OBs that were queued but not been executed in our accepted P100 project. 
...
\RequestedDuplicateRemark{Our fields intentionally overlap with VST optical imaging
  ...
  \medskip
VHS public survey data from VISTA cover some of our target areas too, but the observations are much too shallow for our needs (nor do they include Z or Y bands).
